...
setup(
    ...
    entry_points={
    'console_scripts': [
        'collection_simple = husky_nav_ros2.collection_simple:main',
        'navigation_simple = husky_nav_ros2.navigation_simple:main',
	'manual_waypoint_recorder = husky_nav_ros2.manual_waypoint_recorder:main',
	'waypoint_navigator_pd = husky_nav_ros2.waypoint_navigator_pd:main',
    ],
},
)
